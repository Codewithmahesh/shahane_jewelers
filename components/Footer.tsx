...
const Footer = () => {
  return (
    <footer className="relative bg-[#7c0606] text-white px-4 md:px-10 pt-20 pb-4 font-['Cormorant_Garamond']">
      {/* Raised Logo */}
      ...
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="flex flex-col items-start w-full md:w-1/3 mt-6 md:mt-0">
          <div className="h-[60px]" /> {/* spacer to push content below floating logo */}
          <Image src={qr} alt="QR" width={140} height={140} />
          <p className="mt-2">Download App</p>
          <div className="flex items-center gap-2 mt-2">
            <Image src={playStore} alt="Play Store" width={60} height={40} />
            <Image src={appStore} alt="App Store" width={62} height={40} />
          </div>
        </div>
